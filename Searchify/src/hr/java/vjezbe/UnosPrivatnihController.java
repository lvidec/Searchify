...
public class UnosPrivatnihController {
    ...
    public void unesiButton() throws BazaPodatakaException {
    	...
    	if( imeTextField.getText().toString().length() == 0 && prezimeTextField.getText().toString().length() != 0 && emailTextField.getText().toString().length() != 0 && telefonTextField.getText().toString().length() != 0) {
    		Alert alert = new Alert(AlertType.ERROR);
    		alert.setTitle("ERROR");
    		alert.setContentText("Naslov je obavezan podatak!");
    		alert.showAndWait();
    	}
    	else if( imeTextField.getText().toString().length() == 0 && prezimeTextField.getText().toString().length() == 0 && emailTextField.getText().toString().length() != 0 && telefonTextField.getText().toString().length() != 0) {
    		Alert alert = new Alert(AlertType.ERROR);
    		alert.setTitle("ERROR");
    	...
    	else if( prezimeTextField.getText().toString().length() == 0 && imeTextField.getText().toString().length() != 0 && emailTextField.getText().toString().length() != 0 && telefonTextField.getText().toString().length() != 0) {
    		Alert alert = new Alert(AlertType.ERROR);
    		alert.setTitle("ERROR");
    		alert.setContentText("Opis je obavezan podatak!");
    		alert.showAndWait();
    	}
    	else if( prezimeTextField.getText().toString().length() == 0 && emailTextField.getText().toString().length() == 0 && imeTextField.getText().toString().length() != 0 && telefonTextField.getText().toString().length() != 0) {
    		Alert alert = new Alert(AlertType.ERROR);
    		alert.setTitle("ERROR");
    		alert.setContentText("Opis je obavezan podatak! \nCijena je obavezan podatak!");
    		alert.showAndWait();
    	}
    	else if( prezimeTextField.getText().toString().length() == 0 && emailTextField.getText().toString().length() == 0 && telefonTextField.getText().toString().length() == 0  && imeTextField.getText().toString().length() != 0) {
    		Alert alert = new Alert(AlertType.ERROR);
    		alert.setTitle("ERROR");
    		alert.setContentText("Opis je obavezan podatak! \nCijena je obavezan podatak! \nStanje je obavezan podatak!");
    		alert.showAndWait();
    	}
    	else if( emailTextField.getText().toString().length() == 0 && imeTextField.getText().toString().length() != 0 && prezimeTextField.getText().toString().length() != 0 && telefonTextField.getText().toString().length() != 0) {
    		Alert alert = new Alert(AlertType.ERROR);
    		alert.setTitle("ERROR");
    		alert.setContentText("Cijena je obavezan podatak");
    		alert.showAndWait();
    	}
    	else if( emailTextField.getText().toString().length() == 0 && telefonTextField.getText().toString().length() == 0 && imeTextField.getText().toString().length() != 0 && prezimeTextField.getText().toString().length() != 0) {
    		Alert alert = new Alert(AlertType.ERROR);
    		alert.setTitle("ERROR");
    		alert.setContentText("Cijena je obavezan podatak \nStanje je obavezan podatak!");
    		alert.showAndWait();
    	}
    	else if( telefonTextField.getText().toString().length() == 0 && imeTextField.getText().toString().length() != 0 && prezimeTextField.getText().toString().length() != 0 && emailTextField.getText().toString().length() != 0 ) {
    		Alert alert = new Alert(AlertType.ERROR);
    		alert.setTitle("ERROR");
    		...
    		BazaPodataka.pohraniNoviPrivatniKorisnik(new PrivatniKorisnik(imeTextField.getText(), prezimeTextField.getText(), emailTextField.getText(), telefonTextField.getText(), 5L));
